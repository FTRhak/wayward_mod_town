...
export interface IItemDescription extends IObjectDescription, IModdable {
    ...
    /** @name необхідна для розборки */
    requiredForDisassembly?: Array<ItemType | ItemTypeGroup>;
    decaysInto?: ItemType[];
    twoHanded?: boolean;
    /** @name зберігати міцність на ремеслі */
    ...
    /** @name ремонтується */
    repairable?: boolean;
    /** @name ремонт та демонтаж вимагає огонь */
