...
define(["require", "exports", "./util/Arrays", "./util/decorator/Override"], function (require, exports, Arrays_1, Override_1) {
    "use strict";
    ...
    class ArrayEntriesStream extends ArrayStream {
        getValue() {
            return Arrays_1.tuple(this.index, this.array[this.index]);
        }
    }
    __decorate([
        Override_1.Override
